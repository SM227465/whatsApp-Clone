    ...
    <Stack.Navigator>
      <Stack.Group>
        ...
        <Stack.Screen
          ...
          options={{ gestureEnabled: true, headerTitle: 'Contact Info', headerBackTitle: 'Back' }}
        />
        <Stack.Screen
          name='ChatScreen'
        ...
        <Stack.Screen
          ...
          options={{ headerTitle: '', headerBackTitle: 'Back', headerTitleAlign: 'center' }}
        />
      </Stack.Group>
  ...
  useEffect(() => {
    ...
    responseListener.current = Notifications.addNotificationResponseReceivedListener((response) => {
      ...
      if (chatId) {
        ...
        console.log('No chatId send with notification');
      }
    });
